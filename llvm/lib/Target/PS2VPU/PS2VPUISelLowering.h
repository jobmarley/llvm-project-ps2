//===-- PS2VPUISelLowering.h - PS2VPU DAG Lowering Interface ------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the interfaces that PS2VPU uses to lower LLVM code into a
// selection DAG.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_PS2VPU_PS2VPUISELLOWERING_H
#define LLVM_LIB_TARGET_PS2VPU_PS2VPUISELLOWERING_H
...
class PS2VPUTargetLowering : public TargetLowering {
  const PS2VPUSubtarget *Subtarget;

public:
  PS2VPUTargetLowering(const TargetMachine &TM, const PS2VPUSubtarget &STI);
