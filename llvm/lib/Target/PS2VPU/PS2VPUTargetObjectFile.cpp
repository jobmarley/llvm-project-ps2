//===------- PS2VPUTargetObjectFile.cpp - PS2VPU Object Info Impl -----------===//
//
...
void PS2VPUELFTargetObjectFile::Initialize(MCContext &Ctx,
                                          const TargetMachine &TM) {
  TargetLoweringObjectFileELF::Initialize(Ctx, TM);
}

const MCExpr *PS2VPUELFTargetObjectFile::getTTypeGlobalReference(
