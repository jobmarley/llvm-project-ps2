//===-- PS2VPUISelDAGToDAG.cpp - A dag to dag inst selector for PS2VPU ------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines an instruction selector for the PS2VPU target.
//
//===----------------------------------------------------------------------===//
...
//===--------------------------------------------------------------------===//
/// PS2VPUDAGToDAGISel - PS2VPU specific code to select PS2VPU machine
/// instructions for SelectionDAG operations.
///
namespace {
class PS2VPUDAGToDAGISel : public SelectionDAGISel {
  /// Subtarget - Keep a pointer to the PS2VPU Subtarget around so that we can
...
public:
  ...
  StringRef getPassName() const override {
    return "PS2VPU DAG->DAG Pattern Instruction Selection";
  }

  // Include the pieces autogenerated from the target description.
#include "PS2VPUGenDAGISel.inc"
...
bool PS2VPUDAGToDAGISel::SelectADDRri(SDValue Addr, SDValue &Base,
                                     SDValue &Offset) {
...
bool PS2VPUDAGToDAGISel::tryInlineAsm(SDNode *N) {
...
void PS2VPUDAGToDAGISel::Select(SDNode *N) {
  SDLoc dl(N);
...
/// createPS2VPUISelDag - This pass converts a legalized DAG into a
/// PS2VPU-specific DAG, ready for instruction scheduling.
///
FunctionPass *llvm::createPS2VPUISelDag(PS2VPUTargetMachine &TM) {
  return new PS2VPUDAGToDAGISel(TM);
}
