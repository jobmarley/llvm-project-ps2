//===-- PS2VPUInstPrinter.h - Convert PS2VPU MCInst to assembly syntax ------===//
//
...
class PS2VPUInstPrinter : public MCInstPrinter {
public:
  PS2VPUInstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
  ...
  void printMembarTag(const MCInst *MI, int opNum, const MCSubtargetInfo &STI,
                      raw_ostream &O);
  void printVectorField(const MCInst *MI, int opNum, const MCSubtargetInfo &STI,
                      raw_ostream &O);
};
} // end namespace llvm
